...
class Landingpage extends React.Component<IProps, IState> {
  constructor(props: IProps) {
    ...
    this.changeCategoryOnClickImage =
      this.changeCategoryOnClickImage.bind(this);
      ...
      <div>
        ...
        <div id="searchbar-div">
          <Searchbar
            ...
            changeDisplay={this.changeDisplayProperties}
          />
        </div>
        <div id="landingpage-main-div">
          {this.state.displayCategories ? (
            <Categories
              changeCategoryOnClickImage={this.changeCategoryOnClickImage}
            />
          ) : null}
          {this.state.displayContentRight ? <ContentRight /> : null}
          {this.state.displayShowSearch ? (
            <ShowSearch
  ...
  changeCategoryOnClickImage(event: any) {
    this.setState({
